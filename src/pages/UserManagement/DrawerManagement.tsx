...
const DrawerManagement = ({ selectedUser, handleDrawerActive }: any) => {
  ...
  const apps = [
    ...
    { appname: 'GSuite', type: 'Game' },
    { appname: 'Fornite', type: 'Game' },
    { appname: 'DROP', type: 'Game' },
    { appname: 'LOL', type: 'Game' },
    { appname: 'Vince', type: 'Game' },
    { appname: 'Box', type: 'Game' },
  ...
  return (
    <div style={{ height: '100%' }} className='overflow' ref={ref}>
      <Offset off={offset} configuration={configuration}>
            ...
            <Row>
              <Column>
                ...
                >
                  ...
                  <Pill onClick={handleDrawerActive} background='none' color={dark} />
                </Container>
              </Column>
            </Row>
          </Grid>
        ...
        <Grid expanded>
          <Row>
            <Column>
              <Container top='lg' className={offset ? 'center' : 'no-center'}>
                <div>
                  <Avatar
                      ...
                      <tbody>
                        {apps.map((e) => (
                          <tr key={e.appname}>
                            ...
                            <td>
                              <Paragraph>{e.appname}</Paragraph>
                            </td>
                            <td>
                              <Paragraph>{e.type}</Paragraph>
                            </td>
                          </tr>
                        ))}
                      </tbody>
