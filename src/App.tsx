...
import CohortPage from './components/CohortTable/CohortPage';
  ...
  return (
    <HelmetProvider>
      <AppProvider>
        ...
        <SkeletonTheme
          highlightColor={configuration.colors.navigation.background}
          color={configuration.colors.navigation.background}
        >
          <div
            style={{
              display: 'flex',
